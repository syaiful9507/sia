...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field pengajar on 'MataPelajaran'
        m2m_table_name = db.shorten_name(u'akademik_matapelajaran_pengajar')
        ...
        db.create_unique(m2m_table_name, ['matapelajaran_id', 'guru_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field pengajar on 'MataPelajaran'
        db.delete_table(db.shorten_name(u'akademik_matapelajaran_pengajar'))
    ...
    models = {
        ...
        u'akademik.matapelajaran': {
            ...
            'pengajar': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['akademik.Guru']", 'symmetrical': 'False'})
        },
        u'akademik.siswa': {
